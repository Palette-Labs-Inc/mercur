...
/* tslint:disable */
/* eslint-disable */
import type { StoreStoreCreditAccount } from './StoreStoreCreditAccount';
/**
 * The paginated list of store credit accounts.
 */
export type StoreStoreCreditAccountsResponse = {
    /**
     ...
     */
    store_credit_accounts: Array<StoreStoreCreditAccount>;
    /**
