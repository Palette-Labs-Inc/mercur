...
/* tslint:disable */
/* eslint-disable */
import type { AdminCreateProductType } from '../models/AdminCreateProductType';
import type { AdminProductTypeDeleteResponse } from '../models/AdminProductTypeDeleteResponse';
import type { AdminProductTypeListResponse } from '../models/AdminProductTypeListResponse';
import type { AdminProductTypeResponse } from '../models/AdminProductTypeResponse';
import type { AdminUpdateProductType } from '../models/AdminUpdateProductType';
...
export class AdminProductTypesService {
     ...
     * @param q Search term to filter the product type's searchable properties.
     * @param id
     * @param value
     * @param createdAt Filter by the type's creation date.
     * @param updatedAt Filter by the type's update date.
     * @param deletedAt Filter by the type's deletion date.
     * @param and
     * @param or
     * @param withDeleted Whether to include deleted records in the result.
     * @returns AdminProductTypeListResponse OK
     * @throws ApiError
     */
    public static adminGetProductTypes(
        fields?: string,
        offset?: number,
        limit?: number,
        order?: string,
        ...
        or?: Array<Record<string, any>>,
        withDeleted?: boolean,
    ): CancelablePromise<AdminProductTypeListResponse> {
     ...
     * @param fields Comma-separated fields that should be included in the returned data. if a field is prefixed with `+` it will be added to the default fields, using `-` will remove it from the default fields. without prefix it will replace the entire default fields.
     * @param requestBody
     * @returns AdminProductTypeResponse OK
     * @throws ApiError
     */
    public static adminPostProductTypes(
        fields?: string,
        requestBody?: AdminCreateProductType,
    ): CancelablePromise<AdminProductTypeResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/product-types',
            query: {
     ...
     * @throws ApiError
     */
    public static adminGetProductTypesId(
        id: string,
        fields?: string,
    ): CancelablePromise<AdminProductTypeResponse> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static adminPostProductTypesId(
        id: string,
        fields?: string,
        requestBody?: AdminUpdateProductType,
    ): CancelablePromise<AdminProductTypeResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/product-types/{id}',
     ...
     * @param id The product type's ID.
     * @returns AdminProductTypeDeleteResponse OK
     * @throws ApiError
     */
    public static adminDeleteProductTypesId(
        id: string,
    ): CancelablePromise<AdminProductTypeDeleteResponse> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/admin/product-types/{id}',
            path: {
