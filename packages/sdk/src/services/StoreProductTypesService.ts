...
/* tslint:disable */
/* eslint-disable */
import type { StoreProductTypeListResponse } from '../models/StoreProductTypeListResponse';
import type { StoreProductTypeResponse } from '../models/StoreProductTypeResponse';
import type { CancelablePromise } from '../core/CancelablePromise';
import { OpenAPI } from '../core/OpenAPI';
import { request as __request } from '../core/request';
export class StoreProductTypesService {
    /**
     * List Product Types
     ...
     * @returns StoreProductTypeListResponse OK
     * @throws ApiError
     */
    public static storeGetProductTypes(
        ...
        withDeleted?: boolean,
    ): CancelablePromise<StoreProductTypeListResponse> {
     ...
     * if a field is prefixed with `+` it will be added to the default fields, using `-` will remove it from the default fields.
     * without prefix it will replace the entire default fields.
     * @returns StoreProductTypeResponse OK
     * @throws ApiError
     */
    public static storeGetProductTypesId(
        id: string,
        xPublishableApiKey: string,
        fields?: string,
    ): CancelablePromise<StoreProductTypeResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/store/product-types/{id}',
            path: {
                'id': id,
            },
            headers: {
