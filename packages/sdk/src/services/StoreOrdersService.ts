...
export class StoreOrdersService {
     ...
     * @throws ApiError
     */
    public static storeGetOrdersId(
        id: string,
        xPublishableApiKey: string,
        fields?: string,
     ...
     * @throws ApiError
     */
    public static storePostOrdersIdTransferAccept(
        id: string,
        xPublishableApiKey: string,
        fields?: string,
     ...
     * @throws ApiError
     */
    public static storePostOrdersIdTransferCancel(
        id: string,
        xPublishableApiKey: string,
        fields?: string,
    ): CancelablePromise<StoreOrderResponse> {
     ...
     * @throws ApiError
     */
    public static storePostOrdersIdTransferDecline(
        id: string,
        xPublishableApiKey: string,
        fields?: string,
     ...
     * @throws ApiError
     */
    public static storePostOrdersIdTransferRequest(
        id: string,
        xPublishableApiKey: string,
        fields?: string,
