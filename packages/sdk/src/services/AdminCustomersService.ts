...
/* tslint:disable */
/* eslint-disable */
import type { AdminCustomer } from '../models/AdminCustomer';
import type { AdminCustomerAddress } from '../models/AdminCustomerAddress';
import type { AdminCustomerAddressResponse } from '../models/AdminCustomerAddressResponse';
import type { AdminCustomerResponse } from '../models/AdminCustomerResponse';
import type { CustomerGroupInCustomerFilters } from '../models/CustomerGroupInCustomerFilters';
...
export class AdminCustomersService {
     ...
     * @param groups
     * @param q Search term to filter the customer's searchable properties by.
     * @param id
     * @param email
     * @param companyName
     * @param firstName
     * @param lastName
     * @param createdBy
     * @param createdAt Filter by the customer's creation date.
     * @param updatedAt Filter by a customer's update date.
     * @param deletedAt Filter a customer by their deletion date.
     ...
     * @param hasAccount Filter by whether the customer is registered.
     * @param withDeleted Whether to include deleted records in the result.
     * @returns any OK
     * @throws ApiError
     */
    public static adminGetCustomers(
        fields?: string,
        offset?: number,
        limit?: number,
        order?: string,
        groups?: (string | CustomerGroupInCustomerFilters | Array<string>),
        q?: string,
        ...
        companyName?: (string | Array<string> | {
            /**
             * Join query parameters with an AND condition. Each object's content is the same type as the expected query parameters.
             */
            $and?: Array<Record<string, any>>;
     ...
     * @param fields Comma-separated fields that should be included in the returned data. if a field is prefixed with `+` it will be added to the default fields, using `-` will remove it from the default fields. without prefix it will replace the entire default fields. This API route restricts the fields that can be selected. Learn how to override the retrievable fields in the [Retrieve Custom Links](https://docs.medusajs.com/learn/fundamentals/api-routes/retrieve-custom-links) documentation.
     * @param requestBody
     * @returns AdminCustomerResponse OK
     * @throws ApiError
     */
    public static adminPostCustomers(
        fields?: string,
        requestBody?: ({
            /**
    ...
    ): CancelablePromise<AdminCustomerResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/customers',
            query: {
     ...
     * @throws ApiError
     */
    public static adminGetCustomersId(
        id: string,
        fields?: string,
    ): CancelablePromise<AdminCustomerResponse> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static adminPostCustomersId(
        id: string,
        fields?: string,
        requestBody?: ({
            /**
     ...
     * @throws ApiError
     */
    public static adminDeleteCustomersId(
        id: string,
    ): CancelablePromise<{
        /**
         * The customer's ID.
     ...
     * @param limit Limit the number of items returned in the list.
     * @param order The field to sort the data by. By default, the sort order is ascending. To change the order to descending, prefix the field name with `-`.
     * @param q Search term to apply on the address's searchable properties.
     * @param company
     * @param city
     * @param countryCode
     * @param province
     ...
     * @throws ApiError
     */
    public static adminGetCustomersIdAddresses(
        id: string,
        fields?: string,
        offset?: number,
        limit?: number,
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/customers/{id}/addresses',
            path: {
                'id': id,
            },
            query: {
     ...
     * @throws ApiError
     */
    public static adminPostCustomersIdAddresses(
        id: string,
        fields?: string,
        requestBody?: ({
            /**
     ...
     * @param fields Comma-separated fields that should be included in the returned data. if a field is prefixed with `+` it will be added to the default fields, using `-` will remove it from the default fields. without prefix it will replace the entire default fields. This API route restricts the fields that can be selected. Learn how to override the retrievable fields in the [Retrieve Custom Links](https://docs.medusajs.com/learn/fundamentals/api-routes/retrieve-custom-links) documentation.
     * @returns AdminCustomerAddressResponse OK
     * @throws ApiError
     */
    public static adminGetCustomersIdAddressesAddressId(
        id: string,
        addressId: string,
        fields?: string,
    ): CancelablePromise<AdminCustomerAddressResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/customers/{id}/addresses/{address_id}',
            path: {
                'id': id,
     ...
     * @throws ApiError
     */
    public static adminPostCustomersIdAddressesAddressId(
        id: string,
        addressId: string,
        fields?: string,
        requestBody?: ({
     ...
     * @throws ApiError
     */
    public static adminDeleteCustomersIdAddressesAddressId(
        id: string,
        addressId: string,
        fields?: string,
    ): CancelablePromise<({
     ...
     * @throws ApiError
     */
    public static adminPostCustomersIdCustomerGroups(
        id: string,
        fields?: string,
        requestBody?: {
            /**
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/customers/{id}/customer-groups',
            path: {
                'id': id,
            },
            query: {
