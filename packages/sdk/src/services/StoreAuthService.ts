...
export class StoreAuthService {
     ...
     * @throws ApiError
     */
    public static storePostSession(): CancelablePromise<AuthStoreSessionResponse> {
     ...
     * @throws ApiError
     */
    public static storeDeleteSession(): CancelablePromise<{
        /**
     ...
     * @throws ApiError
     */
    public static storePostAdminAuthTokenRefresh(): CancelablePromise<AuthResponse> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static storePostActorTypeAuthProvider(
        authProvider: string,
     ...
     * @throws ApiError
     */
    public static storePostActorTypeAuthProviderCallback(
        authProvider: string,
     ...
     * @throws ApiError
     */
    public static storePostActorTypeAuthProviderRegister(
        authProvider: string,
        requestBody?: Record<string, any>,
    ): CancelablePromise<AuthResponse> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static storePostActorTypeAuthProviderResetPassword(
        authProvider: string,
        requestBody?: Record<string, any>,
     ...
     * @throws ApiError
     */
    public static storePostActorTypeAuthProviderUpdate(
        authProvider: string,
        requestBody?: Record<string, any>,
    ): CancelablePromise<{
        /**
