...
export class CustomersService {
     ...
     * @throws ApiError
     */
    public static getCustomersMeAddresses(
        xPublishableApiKey: string,
        fields?: string,
        offset?: number,
        limit?: number,
     ...
     * @throws ApiError
     */
    public static postCustomersMeAddresses(
        xPublishableApiKey: string,
        fields?: string,
     ...
     * @throws ApiError
     */
    public static getCustomersMeAddressesAddressId(
        addressId: string,
        xPublishableApiKey: string,
        fields?: string,
     ...
     * @throws ApiError
     */
    public static postCustomersMeAddressesAddressId(
        addressId: string,
        xPublishableApiKey: string,
        fields?: string,
     ...
     * @throws ApiError
     */
    public static deleteCustomersMeAddressesAddressId(
        addressId: string,
        xPublishableApiKey: string,
        fields?: string,
    ): CancelablePromise<({
